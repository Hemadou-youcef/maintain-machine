...
class View(ParentView):
    ...
    def content(self):
        ...
        label = customtkinter.CTkLabel(self.master, text="Feeders List 🛠️")
        ...
        for i, feeder in enumerate(inspected_feeders):
            ...
            if feeder['is_failure'] and not feeder['is_inspected']:
                ...
                feeder_button = customtkinter.CTkButton(master=scrollable_frame, text="Inspect 🛠️", command= lambda feeder=feeder: self.inspect_feeder(feeder))
    ...
    def inspect_feeder(self, feeder):
